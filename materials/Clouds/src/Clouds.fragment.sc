...
#include <newb/config.h>
  ...
  $input v_color1, v_color2, v_fogColor, v_zenithCol, v_horizonCol, v_fogCol
#endif
...
void main() {
  ...
  color = renderClouds(vDir, v_color0.xyz, v_color1.a, v_color2.a, v_horizonCol.rgb, v_zenithCol.rgb);

  #ifdef NL_CLOUD2_MULTILAYER
    vec2 parallax = vDir.xz / abs(vDir.y) * 143.0;
    vec3 offsetPos = v_color0.xyz;
    offsetPos.xz += parallax;
    vec4 color2 = renderClouds(vDir, offsetPos, v_color1.a, v_color2.a*2.0, v_horizonCol.rgb, v_zenithCol.rgb);
